...
if __name__ == "__main__":
    ...
    if response == 1:
        ...
        classify_response("Where is the key?")
        classify_response("Where am I?")
        classify_response("Who are you?")
        classify_response("How is the weather?")
